...
class FormHandler
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "TfLJamCams - Contact Form";
	...
	private function compose_mail($post)
	{
		...
		$content = "Website contact form message received from TfLJamCams website \n\n";
		$content .= "Received on ".date('d M Y h:i:s a', time())."\n\n";
		foreach($post as $name=>$value)
		{
			if (ucwords($name) != 'G-recaptcha-response'){
				if (ucwords($name) == 'Message'){
